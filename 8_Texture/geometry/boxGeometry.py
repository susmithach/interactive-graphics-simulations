...
class BoxGeometry(Geometry):
	"""
	Represents a 3D box geometry.
	"""

	def __init__(self, width=1, height=1, depth=1):
		"""
		Initializes a BoxGeometry object.
		
		Args:
			width (int, optional): The width of the box. Defaults to 1.
			height (int, optional): The height of the box. Defaults to 1.
			depth (int, optional): The depth of the box. Defaults to 1.
		"""
		super().__init__()
		...
		# vertex colors for faces in order: +x, -x, +y, -y, +z, -z
		C1, C2 = [1,0,0], [0.5,0,0]
		C3, C4 = [0,1,0], [0,0.5,0]
		C5, C6 = [0,0,1], [0,0,0.5]
